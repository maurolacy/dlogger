...
#        self.desaturate()
    ...
    def getGainFactors(self):
        ...
        return ( (self.CalibratedPositiveGainX, CalibratedNegativeGainX),
                (self.CalibratedPositiveGainY, CalibratedNegativeGainY),
                (self.CalibratedPositiveGainZ, CalibratedNegativeGainZ) )
