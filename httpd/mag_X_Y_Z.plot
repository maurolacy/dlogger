...
plot "%FIELD1%_%DATE%.txt" using 1:($2) with lines linetype 1 title "X", "%FIELD2%_%DATE%.txt" using 1:($2) with lines linetype 2 title "Y", "%FIELD3%_%DATE%.txt" using 1:($2) with lines linetype 3 title "Z"
